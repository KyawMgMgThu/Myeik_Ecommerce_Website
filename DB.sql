...
VALUES (
        ...
        '$2y$10$EvaSGxbY90rOqk0fkdvmoOJToy5s4oVfZlJzph..4vqQT4jpPCDHS',
        'user.png',
        'Rapidiously extend diverse models before one-to-one architectures. Phosfluorescently envisioneer impactful users rather than corporate action ite',
        'berlin',
        'Germany',
        '3333322111',
        '3333322111',
    ...
    (
        ...
        'joe@gmail.com',
        'joe@gmail.com',
        '$2y$10$tRmAQOgx4m8KGIHTAUDd/u3BPsYH1LJZnGlxXouTdsbkBEfa.uM3O',
        'user.png',
        '',
        '',
        '',
    ...
    (
        ...
        'web@gmail.com',
        'web@gmail.com',
        '$2y$10$kJnCoRMo9O147I/UXh.ZQutUs7vLp9p8eBchUaT5Schm9pVGUc/4e',
        'user.png',
        '',
        '',
        '',
    ...
    (
        ...
        'user@gmail.com',
        'user@gmail.com',
        '$2y$10$fBD2JqjhcoGv/uHxtFDFvuT79OpPRQKAa.6GdsEYt4lNX6ExbsfHy',
        'user.png',
        '',
        '',
        '',
