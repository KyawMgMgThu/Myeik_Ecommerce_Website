    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <ul>
                    <li>
                        <a href="tel:+959662988841"><i class="fa fa-phone"></i> 09662988841</a>
                    </li>
                    <li>
                        <a href="mailto: mthu35997@gmail.com"><i class="fa fa-envelope"></i> hello@domain.com</a>
                    </li>
                </ul>
                ...
                <ul class="social">
                    <li>
                        <a href="https://www.facebook.com/profile.php?id=100057101206481&mibextid=ZbWKwL" target="_blank"><i class="fab fa-facebook-f"></i></a>
                    </li>
                    <li>
                        <a href="https://www.instagram.com/the__boy_iz_min_thu?igsh=bWZjd215ZXlwbTll" target="_blank"><i class="fab fa-instagram"></i></a>
                    </li>
                    <li>
                        <a href="https://github.com/KyawMgMgThu" target="_blank"><i class="fab fa-github"></i></a>
                    </li>
                </ul>
            </div>
        </div>
    </div>
    <p class="copyright">&copy; 2024 | Groceries Organic Store. All rights reserved.</p>
</footer>
